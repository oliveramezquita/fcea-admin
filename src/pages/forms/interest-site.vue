<script setup>
import DialogInterestSiteForm from '@/views/forms/dialog/DialogInterestSiteForm.vue';
    ...
    <VCard class="mb-6">
      <VCardText class="py-12 position-relative">
        ...
        >
          ...
          >
            Formarto de campo digital para los <span class="text-primary text-no-wrap"> Sitios de interés</span>
          </h4>
